...
export default function ActivityKeeptrackBar({ keeptrack, onSave, saving = false, compact = false }) {
  ...
  return (
    <div className={`profile-activity-keeptrack${compact ? ' is-compact' : ''}`}>
